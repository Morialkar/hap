...
const resources = {
  fr: {
    translation: {
      ...
      'reports.title': 'Générateur de rapports',
      'reports.subtitle.database': 'Base de données',
      'reports.subtitle.table': 'Table',
      'reports.newReport': 'Nouveau rapport',
      'reports.savedReports': 'Rapports enregistrés',
      'reports.name.label': 'Nom du rapport',
      'reports.columns.label': 'Colonnes affichées',
      'reports.groupBy.label': 'Grouper par',
      'reports.showHeadersOnly.label': 'Afficher uniquement les en-têtes',
      'reports.sortBy.label': 'Trier par',
      'reports.conditions.label': 'Conditions de filtrage',
      'reports.conditions.logic.and': 'Toutes les conditions (ET)',
      'reports.conditions.logic.or': 'Au moins une condition (OU)',
      'reports.addCondition': 'Ajouter une condition',
      'reports.addSort': 'Ajouter un tri',
      'reports.preview.live': 'Prévisualisation en direct',
      'reports.preview.print': 'Rendu imprimé',
      'reports.print': 'Imprimer',
      'reports.orientation.label': 'Orientation du document',
      'reports.orientation.portrait': 'Portrait',
      'reports.orientation.landscape': 'Paysage',
      'reports.cardColumns.label': 'Fiches par rangée',
      'reports.cardColumns.option_one': '{{count}} fiche par rangée',
      'reports.cardColumns.option_other': '{{count}} fiches par rangée',
      'reports.cardColumns.hint': 'Plus de fiches par rangée réduit le nombre de pages imprimées.',
      'reports.compactCards.label': 'Fiches condensées',
      ...
      'reports.confirmDelete': 'Êtes-vous sûr de vouloir supprimer ce rapport ?',
      'reports.emptyPreview': 'Configurez des colonnes pour prévisualiser le rapport.',
      'reports.loading': 'Chargement des données du rapport...',
      ...
      'workspaces.reports.action': 'Rapports',
  ...
  en: {
    translation: {
      ...
      'reports.subtitle.database': 'Database',
      'reports.subtitle.table': 'Table',
      'reports.newReport': 'New Report',
      'reports.savedReports': 'Saved Reports',
      'reports.name.label': 'Report Name',
      'reports.columns.label': 'Displayed Columns',
      'reports.groupBy.label': 'Group By',
      'reports.showHeadersOnly.label': 'Show headers only',
      'reports.sortBy.label': 'Sort By',
      'reports.conditions.label': 'Filter Conditions',
      'reports.conditions.logic.and': 'All conditions (AND)',
      'reports.conditions.logic.or': 'Any condition (OR)',
      'reports.addCondition': 'Add Condition',
      'reports.addSort': 'Add Sort',
      'reports.preview.live': 'Live Preview',
      'reports.preview.print': 'Print Layout',
      'reports.print': 'Print',
      'reports.orientation.label': 'Document orientation',
      'reports.orientation.portrait': 'Portrait',
      'reports.orientation.landscape': 'Landscape',
      'reports.cardColumns.label': 'Cards per row',
      'reports.cardColumns.option_one': '{{count}} card per row',
      'reports.cardColumns.option_other': '{{count}} cards per row',
      'reports.cardColumns.hint': 'More cards per row means fewer printed pages.',
      'reports.compactCards.label': 'Condensed cards',
      ...
      'reports.emptyPreview': 'Configure columns to preview the report.',
      ...
      'workspaces.reports.action': 'Reports',
